...
const footerLinksLeft = [
  ...
  { text: "이메일무단수집거부", to: "/email-policy" }
];
...
const companyInfo = {
  ...
  escrowDesc: "고객님의 안전거래를 위해 현금 등으로 5만원 이상 결제 시 저희 쇼핑몰에서 가입한 구매안전(에스크로) 서비스를 이용하실 수 있습니다.",
      ...
      <div className="container">
        ...
        <div className="footer-top">
          <div className="footer-links-wrapper">
            ...
            {/* 중앙 그룹 */}
            <div className="footer-links-group">
              {footerLinksCenter.map((link, index) => (
        ...
        <div className="footer-content">
          <div className="company-info">
            ...
            <p>
              ...
              <a href="#" className="info-link">사업자정보확인</a> ㅣ
              통신판매업 신고번호: {companyInfo.ecommerceNumber} ㅣ
              호스팅서비스: {companyInfo.hosting}
            </p>
            <p>
              {companyInfo.escrow}{" "}
              <a href="#" className="info-link">{companyInfo.escrowLink}</a>{" "}
          ...
          <div className="footer-bottom">
            ...
            <div className="footer-bottom-left">
              <p>Copyright (C) {currentYear} Samsung C&T Corporation. All rights reserved</p>
            </div>

            {/* 인증 영역 - 아래 줄 */}
            <div className="footer-bottom-right">
              <div className="certification">
                <img src="https://ext.same-assets.com/947818454/209907754.png" alt="ISMS 인증마크" />
                <p>
